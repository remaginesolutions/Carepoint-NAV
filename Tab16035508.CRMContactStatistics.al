table 16035508 "CRM Contact Statistics"
{
    // version CAREPOINT1.00

    Caption = 'Contact Statistics';
    Description = 'An entity to store aggregate statistics from Dynamics NAV about a contact.';
    ExternalName = 'hbs_contactstatistics';
    TableType = CRM;

    fields
    {
        field(1;ContactStatisticsId;Guid)
        {
            Description = 'Unique identifier for entity instances';
            ExternalAccess = Insert;
            ExternalName = 'hbs_contactstatisticsid';
        ...
        field(27;"Balance (Base)";Decimal)
        {
            ...
            ExternalAccess = Read;
            ExternalName = 'rs_balancelcy_base';
            ExternalType = 'Money';
        }
        field(28;"Outstanding Orders (LCY)";Decimal)
        {
            ...
            Description = '';
            ExternalName = 'rs_outstandingorderslcy';
            ExternalType = 'Money';
        }
        field(29;"Outstanding Orders (Base)";Decimal)
        {
            ...
            ExternalAccess = Read;
            ExternalName = 'rs_outstandingorderslcy_base';
            ExternalType = 'Money';
        }
        field(30;"Shipped Not Invoiced (LCY)";Decimal)
        {
            ...
            Description = '';
            ExternalName = 'rs_shippednotinvoicedlcy';
            ExternalType = 'Money';
        }
        field(31;"Shipped Not Invoiced (Base)";Decimal)
        {
            ...
            ExternalAccess = Read;
            ExternalName = 'rs_shippednotinvoicedlcy_base';
            ExternalType = 'Money';
        }
        field(32;"Outstanding Invoices (LCY)";Decimal)
        {
            ...
            Description = '';
            ExternalName = 'rs_outstandinginvoiceslcy';
            ExternalType = 'Money';
        }
        field(33;"Outstanding Invoices (Base)";Decimal)
        {
            ...
            ExternalAccess = Read;
            ExternalName = 'rs_outstandinginvoiceslcy_base';
            ExternalType = 'Money';
        }
        field(34;"Outstanding Serv Orders (LCY)";Decimal)
        {
            ...
            Description = '';
            ExternalName = 'rs_outstandingservorderslcy';
            ExternalType = 'Money';
        }
        field(35;"Outstanding Serv Orders (Base)";Decimal)
        {
            ...
            ExternalAccess = Read;
            ExternalName = 'rs_outstandingservorderslcy_base';
            ExternalType = 'Money';
        }
        field(36;"Serv Shipped Not Invd (LCY)";Decimal)
        {
            ...
            Description = '';
            ExternalName = 'rs_servshippednotinvdlcy';
            ExternalType = 'Money';
        }
        field(37;"Serv Shipped Not Invd (Base)";Decimal)
        {
            ...
            ExternalAccess = Read;
            ExternalName = 'rs_servshippednotinvdlcy_base';
            ExternalType = 'Money';
        }
        field(38;"Outstd Serv Invoices (LCY)";Decimal)
        {
            ...
            Enabled = false;
            ExternalName = 'rs_outstandingservinvoiceslcy';
        }
        field(39;"Outstd Serv Invoices (Base)";Decimal)
        {
            ...
            Enabled = false;
            ExternalAccess = Read;
            ExternalName = 'rs_outstandingservinvoiceslcy_base';
        }
        field(40;"Total (LCY)";Decimal)
        {
            Caption = 'Total (LCY)';
            Description = '';
            ExternalName = 'rs_totallcy';
            ExternalType = 'Money';
        }
        ...
        field(42;"Credit Limit (LCY)";Decimal)
        {
            ...
            Description = '';
            ExternalName = 'rs_creditlimitlcy';
            ExternalType = 'Money';
        }
        field(43;"Credit Limit (Base)";Decimal)
        {
            ...
            ExternalAccess = Read;
            ExternalName = 'rs_creditlimitlcy_base';
            ExternalType = 'Money';
        }
        field(44;"Overdue Amounts (LCY)";Decimal)
        {
            ...
            Description = '';
            ExternalName = 'rs_overdueamountslcy';
            ExternalType = 'Money';
        }
        field(45;"Overdue Amounts (Base)";Decimal)
        {
            ...
            ExternalAccess = Read;
            ExternalName = 'rs_overdueamountslcy_base';
            ExternalType = 'Money';
        }
        field(46;"Overdue Amounts As Of Date";Date)
        {
            ...
            ExternalName = 'rs_overdueamountasof';
            ExternalType = 'DateTime';
        }
        ...
        field(48;"Total Sales (Base)";Decimal)
        {
            ...
            ExternalAccess = Read;
            ExternalName = 'rs_totalsaleslcy_base';
            ExternalType = 'Money';
        }
        field(49;"Invd Prepayment Amount (LCY)";Decimal)
        {
            ...
            Description = '';
            ExternalName = 'rs_invoicedprepaymentamount';
            ExternalType = 'Money';
        }
        field(50;"Invd Prepayment Amount (Base)";Decimal)
        {
            ...
            ExternalAccess = Read;
            ExternalName = 'rs_invoicedprepaymentamount_base';
            ExternalType = 'Money';
        }
    }
