table 16035506 "CRM Programme"
{
    ...
    fields
    {
        field(1;hbs_programmeId;Guid)
        {
            Caption = 'Programme';
            Description = 'Unique identifier for entity instances';
            ExternalAccess = Insert;
            ExternalName = 'hbs_programmeid';
        ...
        {
            Caption = 'Status';
            Description = 'Status of the Programme';
        ...
        field(5;statuscode;Option)
        {
            ...
            Description = 'Reason for the status of the Programme';
        ...
        field(12;hbs_description;Text[250])
        {
            Caption = 'Description';
            Description = '';
        ...
        field(13;hbs_subprogramme;Guid)
        {
            Caption = 'Subprogramme';
            Description = '';
            ExternalName = 'hbs_subprogramme';
            ExternalType = 'Lookup';
            TableRelation = "CRM Subprogramme".hbs_subprogrammeId;
        }
        field(14;hbs_subprogrammeName;Text[100])
        {
            ExternalAccess = Read;
            ExternalName = 'hbs_subprogrammename';
            ExternalType = 'String';
        }
